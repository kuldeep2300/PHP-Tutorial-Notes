...
Instead of storing all complete : <a href = "https://www.google.com"></a> we will store it into database in encoding form like `&lt;a href = &quot;https://www.google.com&quot;&gt; &lt;/a&gt;`. This form will be store in the database that will prevent hacker and ensure safety.
...
//? Incoding 
// echo htmlentities($myname);    // Go to view page source check there - We don't give flags and default its flag ENT_COMPACT (for double quotes) but it will apply on both single and double quotes, and it will encode both.
